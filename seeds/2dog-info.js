...
export async function seed(knex) {
  ...
  await knex('dogs').insert([
    ...
    { id: 4, user_id: 4, name: 'Charlie', age: '18 months', breed: 'Bulldog', personality: 'Aloof/Predatory', photo: 'http://localhost:8080/uploads/bulldog/bull1.jpeg' },
    ...
    { id: 13, user_id: 13, name: 'Zoey', age: '14 months', breed: 'Bulldog', personality: 'Anxious/Fearful', photo: 'http://localhost:8080/uploads/bulldog/bull2.jpg' },
    ...
    { id: 22, user_id: 22, name: 'Daisy', age: '19 months', breed: 'Bulldog', personality: 'Excitable/Hyperattached', photo: 'http://localhost:8080/uploads/bulldog/bull3.jpg' },
